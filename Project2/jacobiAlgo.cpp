...
void JacobiEigenSolve::Solve(){
  ...
  while (max_val > eps && iterations < max_iterations ){
    ...
    //If n chosen is within 10 - 200, progress will be printed
    map<int, int> dictIte = { {10 , 137}, {20 , 655}, {30 , 1543}, {40 , 2762}, {50 , 4373}, {60 , 6312}, {70 , 8603}, {80 , 11205}, {90 , 14216}, {100 , 17601},
    {110 , 21384}, {120 , 25528}, {130 , 29765}, {140 , 34809}, {150 , 40020}, {160, 45319}, {170, 51262}, {180, 57578}, {190, 64155}, {200, 70844} };//add more values if needed
